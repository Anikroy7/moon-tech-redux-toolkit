...
import { addProduct, tooglePostSuccess } from "../../features/products/productSlice";
...
const AddProduct = () => {
  ...
  // console.log(state, "form add product");
  console.log(isLoading, postSuccess, isError, error);
  ...
  return (
    <section>
      <h1 className="text-2xl font-bold text-center p-4">Add Product</h1>
