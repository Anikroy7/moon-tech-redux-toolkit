...
import { deleteProductById, getProducts, toogleDeleteSuccess } from "../../features/products/productSlice";


const ProductList = () => {
  const { products, isLoading, deleteSuccess, isError, error } = useSelector(state => state.products);
  console.log(products, isLoading, deleteSuccess, isError, error);
